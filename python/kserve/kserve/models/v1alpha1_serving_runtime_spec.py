...
class V1alpha1ServingRuntimeSpec(object):
    ...
    openapi_types = {
        ...
        'supported_model_types': 'list[V1alpha1Framework]',
    ...
    def __init__(self, affinity=None, built_in_adapter=None, containers=None, disabled=None, grpc_data_endpoint=None, grpc_endpoint=None, http_data_endpoint=None, node_selector=None, replicas=None, storage_helper=None, supported_model_types=None, tolerations=None, local_vars_configuration=None):  # noqa: E501
    ...
    def supported_model_types(self):
        """Gets the supported_model_types of this V1alpha1ServingRuntimeSpec.  # noqa: E501

        Model formats and version supported by this runtime  # noqa: E501

        :return: The supported_model_types of this V1alpha1ServingRuntimeSpec.  # noqa: E501
        :rtype: list[V1alpha1Framework]
        """
        return self._supported_model_types

    @supported_model_types.setter
    def supported_model_types(self, supported_model_types):
        """Sets the supported_model_types of this V1alpha1ServingRuntimeSpec.

        Model formats and version supported by this runtime  # noqa: E501

        :param supported_model_types: The supported_model_types of this V1alpha1ServingRuntimeSpec.  # noqa: E501
        :type: list[V1alpha1Framework]
        """
